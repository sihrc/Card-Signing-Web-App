var Handwriting = (function (document) {
    ...
    Handwriting.prototype._strokeUpdate = function (event) {
    ...
    Handwriting.prototype._strokeDraw = function (point) {
        var ctx = this._ctx,
    ...
    Handwriting.prototype._handleMouseEvents = function () {
        var self = this;
    ...
    Handwriting.prototype._handleTouchEvents = function () {
        var self = this;
    ...
    Handwriting.prototype.isEmpty = function () {
        return this._isEmpty;
    };

    Handwriting.prototype._reset = function () {
        this.points = [];
    ...
    Handwriting.prototype._createPoint = function (event) {
    ...
    Handwriting.prototype._addPoint = function (point) {
    ...
    Handwriting.prototype._calculateCurveControlPoints = function (s1, s2, s3) {
    ...
    Handwriting.prototype._addCurve = function (curve) {
    ...
    Handwriting.prototype._drawPoint = function (x, y, size) {
        var ctx = this._ctx;
